...
const AVAILABLE_FILTERS = ['Vegetariano', 'Vegano', 'Desayunos', 'Comidas', 'Cenas', 'Postres'];
...
export default function Home({ navigation }) {
  ...
  const filteredRecipes = RECIPES.filter(recipe => {
    ...
    const matchesFilters = activeFilters.length === 0 || activeFilters.some(filter => recipe.categories.includes(filter));
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.searchSection}>
          ...
          >
            <Ionicons name="options-outline" size={24} color={showFilters ? "#FFF" : "#333"} />
          </TouchableOpacity>
        </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={styles.emptyText}>No se encontraron recetas con esos filtros.</Text>
          }
        />
      </View>

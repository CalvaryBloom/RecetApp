...
-- Eliminar tablas si ya existen (orden por FK)
...
-- Tabla intermedia: muchos usuarios ↔ muchas alergias
...
-- 1.5 Usuarios (ya NO llevan alergia_id)
INSERT INTO usuarios (nombre, apellidos, correo, password) VALUES
('Borja',  'García',    'test@app.com',        '123456'),
('Ana',    'López',     'ana.lopez@app.com',   'hasheado123'),
('Carlos', 'Martínez',  'carlos.m@app.com',    'hasheado123'),
('Laura',  'Gómez',     'laura.g@app.com',     'hasheado123');
...
-- Asignación de alergias (usuario ↔ alergias)
-- Borja: Ninguna
INSERT INTO usuario_alergias (usuario_id, alergia_id) VALUES (@id_borja, @id_ninguna);

-- Ana: Lactosa
INSERT INTO usuario_alergias (usuario_id, alergia_id) VALUES (@id_ana, @id_lactosa);

-- Carlos: Ninguna
INSERT INTO usuario_alergias (usuario_id, alergia_id) VALUES (@id_carlos, @id_ninguna);

-- Laura: Gluten
INSERT INTO usuario_alergias (usuario_id, alergia_id) VALUES (@id_laura, @id_gluten);
...
-- 4. Ingredientes (igual que antes)
...
-- 5. Recetas-Categorías (igual que antes)
...
-- 6. Favoritos y Listas (igual que antes, usando ids ya seteados)
